...
if __name__ == "__main__":
    ...
    parser.add_argument("--solution", type=str, default="default_value", help="run test for the solution provided by user")
    ...
    for topology_file in topology_files:
        ...
        # Run tests
        if args.all:
            print(f"*** Start testing all the solutions")
            solutions_file = f"{output_path}/solutions.json"
            main.test_all_solutions(solutions_file)
            print(f"*** End of testing")
        elif args.solution:
            print(f"*** Start testing the following solution: {args.solution}")
