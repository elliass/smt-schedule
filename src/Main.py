...
def get_topology_files(is_analysis=False):
    topology_files = []
    input_directory = "../definition"
    if is_analysis:
        input_directory = "../definition/sensitivity_analysis"
...
class Main:
    ...
    def output_topology(self):
        ...
        print(data)
        self.write_to_text(data, '../out/topology.txt')
    ...
    def output_slotframe(self, slotframe):
        ...
        data = header + "\n" + str(table)
        print(data)
        self.write_to_text(data, '../out/slotframe.txt')
    ...
    def output_logs(self, file):
        ...
        self.write_to_json(data, '../out/logs.json')
